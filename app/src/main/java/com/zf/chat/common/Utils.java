...
public class Utils {
    ...
    public static void putBooleanValue(Context context, String key, boolean bl) {
    ...
    public static long getLongValue(Context context, String key, long default_data) {
        return getSharedPreference(context).getLong(key, default_data);
    }

    public static boolean putLongValue(Context context, String key, Long value) {
        Editor editor = getSharedPreference(context).edit();

...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                tv_pager.setText(getString(R.string.select, currentItem + 1, imageInfo.size()));
            }
        });
        tv_pager.setText(getString(R.string.select, currentItem + 1, imageInfo.size()));
    }
    ...
    public boolean onPreDraw() {
        ...
        final float vx = imageData.getImageViewWidth() * 1.0f / imageWidth;
        final float vy = imageData.getImageViewHeight() * 1.0f / imageHeight;
        ...
        valueAnimator.addUpdateListener(animation -> {
            ...
            view.setTranslationX(evaluateInt(fraction, imageData.getImageViewX() + imageData.getImageViewWidth() / 2
                    - imageView.getWidth() / 2, 0));
            view.setTranslationY(evaluateInt(fraction, imageData.getImageViewY() + imageData.getImageViewHeight() / 2
    ...
    public void finishActivityAnim() {
        ...
        valueAnimator.addUpdateListener(animation -> {
            ...
            float fraction = duration > 0 ? (float) playTime / duration : 1f;
            if (fraction > 1) fraction = 1;
            view.setTranslationX(evaluateInt(fraction, 0, imageData.getImageViewX() + imageData.getImageViewWidth() /
                    2 - imageView.getWidth() / 2));
            view.setTranslationY(evaluateInt(fraction, 0, imageData.getImageViewY() + imageData.getImageViewHeight()
                    / 2 - imageView.getHeight() / 2));
